...
const Dashboard = () => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold mb-2">
                Welcome back,{' '}
                {userPreferences?.name?.split(' ')[0] || 'Student'}!
              </h1>
              <p className="text-muted-foreground">
                Your personalized learning journey awaits. Ready to continue
                where you left off?
              </p>
            </div>
      ...
      <section className="mb-12 px-6 md:px-8">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold">Your Learning Paths</h2>
          <Link
            to="/paths"
            className="text-sm text-hotteach-red hover:underline">
            View all paths
          </Link>
        </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="w-full md:w-3/5">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Connect with like-minded learners, share your progress, and
              ...
              <Card className="p-5">
                ...
                <ul className="space-y-3">
                  <li className="border-b pb-2">
                    <a href="#" className="hover:text-hotteach-red">
...
const learningPaths = [
  {
    ...
    description:
      'Master the core concepts of HTML, CSS, and JavaScript to build modern websites.',
  ...
  },
  {
    ...
    description:
      'Learn to build dynamic UIs with React, the popular JavaScript library.',
...
const projects = [
  {
    ...
    description:
      'Create a stunning portfolio website to showcase your projects and skills.',
    difficulty: 'beginner' as const,
    topics: ['HTML', 'CSS', 'JavaScript', 'Responsive Design'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Create a dashboard that integrates with multiple social media platforms.',
    difficulty: 'advanced' as const,
