          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                ...
                <label
                  key={goal}
                  className="flex items-center gap-2 p-3 rounded-lg border border-border hover:border-hotteach-red/50 cursor-pointer transition-colors">
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        ...
                        updateUserPreferences({
                          goals: userPreferences.goals.filter(
                            (g) => g !== goal
                          ),
                        });
                      }
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-2">
              {[
                {
                  label: "Beginner - I'm just starting out",
                  value: 'beginner',
                },
                {
                ...
                <label
                  ...
                  <input
                    ...
                    onChange={() =>
                      updateUserPreferences({ experience: level.value as any })
                    }
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        ...
                        updateUserPreferences({
                          interests: userPreferences.interests.filter(
                            (i) => i !== interest
                          ),
                        });
                      }
              ...
              {[
                ...
                <label
                  ...
                  <input
                    ...
                    onChange={() =>
                      updateUserPreferences({
                        timeCommitment: time.value as any,
                      })
                    }
                    className="text-hotteach-red"
                  />
